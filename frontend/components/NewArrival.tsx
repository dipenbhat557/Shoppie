...
const cards = [
  {
    img: '/placeholder/ps5.png',
    title: 'PlayStation 5',
    desc: 'Black and White version of the PS5 coming out on sale.',
  },
  {
    img: '/placeholder/women.png',
    title: "Women’s Collections",
    desc: 'Featured women collections that give you another vibe.',
  },
  {
    img: '/placeholder/speakers.png',
    title: 'Speakers',
    desc: 'Amazon wireless speakers',
  },
  {
    img: '/placeholder/perfume.png',
    title: 'Perfume',
  ...
  return (
    <section className="w-full max-w-7xl mx-auto mt-8 mb-12 px-2 sm:px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-3 md:grid-rows-2 gap-4">
        ...
        {/* Bottom right cards: each col-span-1, row-span-1 */}
        <div className="relative rounded-xl overflow-hidden min-h-[120px] col-span-1 row-span-1 group">
          <Image src={cards[2].img} alt={cards[2].title} fill className="object-cover w-full h-full" />
          <div className="absolute inset-0 bg-black/60" />
          <div className="relative z-10 p-6 flex flex-col gap-2 items-start justify-end h-full">
        ...
        <div className="relative rounded-xl overflow-hidden min-h-[120px] col-span-1 row-span-1 group">
          <Image src={cards[3].img} alt={cards[3].title} fill className="object-cover w-full h-full" />
          <div className="absolute inset-0 bg-black/60" />
          <div className="relative z-10 p-6 flex flex-col gap-2 items-start justify-end h-full">
