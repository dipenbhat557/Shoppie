...
import { ProductVariant } from "@/fetchers/product/queries";
...
export function VariantList({ productId }: { productId: number }) {
                  ...
                  <div key={group.id}>
                    ...
                    <select
                      value={editForm.optionIds.find((id) => 
                        group.productOptions.some((opt) => opt.id === id)
                      )}
                      onChange={(e) => {
                    ...
                    >
                      ...
                      {group.productOptions.map((option) => (
              ...
              <div className="p-4">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {variant.productOptions.map((option) => (
                    ...
                    >
                      {option.productOptionGroup.name}: {option.name}
                    </span>
                  ))}
                </div>
              </div>
