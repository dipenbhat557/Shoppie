...
exports.CarouselComponent = function () {
    return (React.createElement("div", { className: "relative w-[90%] overflow-hidden " + styles_1.styles.screenMarginAuto + " flex items-center justify-center pt-10" },
        React.createElement(carousel_1.Carousel, { plugins: [
                embla_carousel_autoplay_1["default"]({
                    delay: 4000
                }),
            ] },
            React.createElement(carousel_1.CarouselContent, { className: "relative w-full h-full" },
