...
exports.Topbar = function () {
    return (React.createElement("div", { className: "bg-black text-white w-full p-3  text-[8px] md:text-xs lg:text-sm  " },
        React.createElement("div", { className: "flex " + styles_1.styles.maxScreenWidth + "  " + styles_1.styles.screenMarginAuto + "  justify-between" },
            ...
            React.createElement("div", { className: "flex justify-evenly sm:w-[60%] md:w-3/5 lg:w-2/5" },
