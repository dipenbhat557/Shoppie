...
exports.HomeDecorComponent = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: "  hover:bg-slate-100     overflow-hidden " },
        ...
        react_1["default"].createElement("div", { className: "p-4 text-center" },
            react_1["default"].createElement("p", { className: "text-gray-700 md:text-sm text-xs " }, companyName),
            react_1["default"].createElement("p", { className: "text-sm md:text-xl font-bold text-black pt-2" }, offer))));
};
